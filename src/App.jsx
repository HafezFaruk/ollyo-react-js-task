  ...
  return (
    <div className="py-20 px-5">
      <div className="container mx-auto bg-white rounded-xl">
        ...
        <hr />
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5 p-5 lg:p-10">
          ...
          <div>
            <label className="w-full h-full min-h-[300px] flex flex-col justify-center items-center px-4 py-6 bg-white text-blue rounded-lg  tracking-wide border border-blue cursor-pointer hover:bg-gray-200">
